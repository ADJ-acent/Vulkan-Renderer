...
void RTGRenderer::ShadowAtlas::update_regions(std::vector<RTGRenderer::LambertianPipeline::SpotLight> & spot_lights, std::vector<Scene::LightInstance> &sorted_indices, uint8_t reduction)
{
    regions.clear();
