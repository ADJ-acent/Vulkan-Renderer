...
void RTGRenderer::PBRPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
    VkShaderModule vert_module = rtg.helpers.create_shader_module(vert_code);
    VkShaderModule frag_module = rtg.helpers.create_shader_module(frag_code);

    {//the set0_World layout holds world info in a uniform buffer used in the fragment shader and the environment cubemap:
    ...
    { //the set2_TEXTURE layout has 3 sampler2Ds used in the fragment shader (normal, displacement, albedo, roughness, metalness):
...
void RTGRenderer::PBRPipeline::destroy(RTG &rtg) {
